...
const he: Record<string, string> = {
  ...
  'assistant.history': 'היסטוריית שיחות',
  'assistant.historyEmpty': 'אין שיחות קודמות',
  'assistant.loadSession': 'טען שיחה',
  'assistant.deleteSession': 'מחק שיחה',
  'assistant.deleteAll': 'מחק הכל',
  'assistant.deleteConfirm': 'האם למחוק את השיחה הזו?',
  'assistant.deleteAllConfirm': 'האם למחוק את כל השיחות?',
  'assistant.sessionLimit': 'מכסה: {{limit}} שיחות',
  'assistant.unlimited': 'ללא הגבלה',
  'assistant.messages': 'הודעות',
  ...
  'admin.llmConfig.name': 'שם תצורה',
  'admin.llmConfig.savedConfigs': 'תצורות שמורות',
  'admin.llmConfig.noSavedConfigs': 'אין תצורות שמורות',
  'admin.llmConfig.active': 'פעיל',
  'admin.llmConfig.activate': 'הפעל',
  'admin.llmConfig.createNew': 'צור תצורה חדשה',
  'admin.llmConfig.saveAndActivate': 'שמור והפעל',
  'admin.llmConfig.saveOnly': 'שמור בלבד',
  'admin.llmConfig.savedNotActive': 'התצורה נשמרה (לא פעילה). הפעל אותה כדי להשתמש.',
  'admin.llmConfig.activated': 'התצורה הופעלה בהצלחה',
  'admin.llmConfig.deleted': 'התצורה נמחקה',
  'admin.llmConfig.deleteConfirm': 'האם למחוק את התצורה הזו?',
  'admin.llmConfig.test': 'בדוק חיבור',
  'admin.llmConfig.testOk': 'החיבור הצליח',
  'admin.llmConfig.testFailed': 'החיבור נכשל',
  'admin.llmConfig.selectModel': 'בחר מודל...',
  'admin.llmConfig.typeModel': 'הקלד שם מודל...',
  'admin.llmConfig.fetchModels': 'טען רשימת מודלים',
  'admin.llmConfig.loadingModels': 'טוען מודלים...',
  'admin.llmConfig.modelsLoaded': '{{count}} מודלים זמינים',
  'admin.llmConfig.defaultUrlHint': 'ברירת מחדל: {{url}}',
  'admin.llmConfig.enterApiKey': 'הזן מפתח API',
  'admin.llmConfig.updatedAt': 'עודכן ב',
...
const en: Record<string, string> = {
  ...
  'assistant.historyEmpty': 'No previous conversations',
  'assistant.loadSession': 'Load conversation',
  'assistant.deleteSession': 'Delete conversation',
  'assistant.deleteAll': 'Delete all',
  'assistant.deleteConfirm': 'Delete this conversation?',
  'assistant.deleteAllConfirm': 'Delete all conversations?',
  'assistant.sessionLimit': 'Quota: {{limit}} chats',
  ...
  'admin.llmConfig.name': 'Config Name',
  'admin.llmConfig.savedConfigs': 'Saved Configurations',
  'admin.llmConfig.noSavedConfigs': 'No saved configurations',
  'admin.llmConfig.active': 'Active',
  'admin.llmConfig.activate': 'Activate',
  'admin.llmConfig.createNew': 'Create New Configuration',
  'admin.llmConfig.saveAndActivate': 'Save & Activate',
  'admin.llmConfig.saveOnly': 'Save Only',
  'admin.llmConfig.savedNotActive': 'Configuration saved (inactive). Activate it to use.',
  'admin.llmConfig.activated': 'Configuration activated successfully',
  'admin.llmConfig.deleted': 'Configuration deleted',
  'admin.llmConfig.deleteConfirm': 'Delete this configuration?',
  'admin.llmConfig.test': 'Test connection',
  'admin.llmConfig.testOk': 'Connection successful',
  'admin.llmConfig.testFailed': 'Connection failed',
  'admin.llmConfig.selectModel': 'Select a model...',
  'admin.llmConfig.typeModel': 'Type a model name...',
  'admin.llmConfig.fetchModels': 'Fetch model list',
  'admin.llmConfig.loadingModels': 'Loading models...',
  'admin.llmConfig.modelsLoaded': '{{count}} models available',
  'admin.llmConfig.defaultUrlHint': 'Default: {{url}}',
  'admin.llmConfig.enterApiKey': 'Enter API key',
  'admin.llmConfig.updatedAt': 'Updated',
