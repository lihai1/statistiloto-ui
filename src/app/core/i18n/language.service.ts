...
const he: Record<string, string> = {
  ...
  'assistant.selectModel': 'בחר מודל',
  ...
  'admin.llmConfig.editConfig': 'ערוך תצורה',
  'admin.llmConfig.edit': 'ערוך',
  'admin.llmConfig.update': 'עדכן',
  'admin.llmConfig.cancel': 'ביטול',
  'admin.llmConfig.updated': 'התצורה עודכנה בהצלחה',
  ...
  'admin.llmConfig.cap.embedding': 'הטמעות',
  'admin.llmConfig.cap.vision': 'ראייה',
  'admin.llmConfig.cap.tools': 'כלים',
  'admin.llmConfig.cap.thinking': 'חשיבה',
  'admin.llmConfig.freeTierLlm': 'הפעלת AI למשתמשים בחינם',
  'admin.llmConfig.freeTierLlmHint': 'כשכבוי, משתמשים בחינם מקבלים תגובה כללית לשאלות כלליות או מבולבלות במקום קריאה למודל השפה. פעולות ספציפיות (טפסים, סטטיסטיקה, ניתוח) עובדות תמיד.',
  'admin.llmConfig.freeTierLlmEnabled': 'AI למשתמשים בחינם מופעל',
  'admin.llmConfig.freeTierLlmDisabled': 'AI למשתמשים בחינם כבוי',
  ...
  'home.action.simulate': 'סימולציית לוטו',
  ...
  // ── Simulate ──
  'simulate.title': 'סימולציית לוטו',
  'simulate.subtitle': 'בחר מספרים ובדוק כמה היית מוציא וזוכה על פני תקופת זמן.',
  'simulate.formSize': 'גודל טופס',
  'simulate.ticketCost': 'עלות לטבלה (₪)',
  'simulate.selectedNumbers': 'מספרים שנבחרו',
  'simulate.clear': 'נקה',
  'simulate.strongNumber': 'מספר חזק',
  'simulate.prizeConfig': 'הגדרת סכומי פרסים',
  'simulate.button': 'הרץ סימולציה',
  'simulate.results': 'תוצאות סימולציה',
  'simulate.totalDraws': 'מספר הגרלות',
  'simulate.totalSpent': 'סה"כ הוצאה',
  'simulate.totalWon': 'סה"כ זכייה',
  'simulate.net': 'רווח/הפסד נטו',
  'simulate.tierSummary': 'סיכום לפי דרגת זכייה',
  'simulate.tier': 'דרגה',
  'simulate.hits': 'מספר זכיות',
  'simulate.amount': 'סכום',
  'simulate.drawHistory': 'היסטוריית הגרלות',
  'simulate.drawDate': 'תאריך',
  'simulate.winningNumbers': 'מספרים זוכים',
  'simulate.strongShort': 'חזק',
  'simulate.tierHit': 'דרגת זכייה',
  'simulate.prize': 'פרס',
  'simulate.cost': 'עלות',
  'simulate.noWins': 'אין זכיות בתקופה הנבחרת',
  'simulate.maxNumbers': 'ניתן לבחור עד {n} מספרים',
  'simulate.needNumbers': 'בחר בדיוק {n} מספרים',
  'simulate.needStrong': 'בחר מספר חזק',
  'simulate.realPrizes': 'פרסים אמיתיים',
  'simulate.prizeSource': 'מקור פרס',
  'simulate.real': 'אמיתי',
  'simulate.estimate': 'הערכה',
  'simulate.loadSaved': 'טען מספרים שמורים',
  'simulate.selectSaved': '— בחר סט שמור —',
  'simulate.noSaved': 'אין מספרים שמורים. שמור מספרים בדף "המספרים שלי" או "הגרל".',
  'simulate.loadedSaved': 'מספרים שמורים נטענו',
...
const en: Record<string, string> = {
  ...
  'admin.llmConfig.editConfig': 'Edit Configuration',
  'admin.llmConfig.edit': 'Edit',
  'admin.llmConfig.update': 'Update',
  'admin.llmConfig.cancel': 'Cancel',
  'admin.llmConfig.updated': 'Configuration updated successfully',
  ...
  'admin.llmConfig.cap.embedding': 'Embeddings',
  'admin.llmConfig.cap.vision': 'Vision',
  'admin.llmConfig.cap.tools': 'Tools',
  'admin.llmConfig.cap.thinking': 'Thinking',
  'admin.llmConfig.freeTierLlm': 'Enable AI for free users',
  'admin.llmConfig.freeTierLlmHint': 'When off, free users get a generic response for general or ambiguous questions instead of calling the LLM. Specific actions (forms, statistics, analysis) always work.',
  'admin.llmConfig.freeTierLlmEnabled': 'Free-tier AI enabled',
  'admin.llmConfig.freeTierLlmDisabled': 'Free-tier AI disabled',
  ...
  'home.action.simulate': 'Lottery Simulation',
  ...
  // ── Simulate ──
  'simulate.title': 'Lottery Simulation',
  'simulate.subtitle': 'Pick numbers and see how much you would have spent and won over a period.',
  'simulate.formSize': 'Form size',
  'simulate.ticketCost': 'Cost per table (ILS)',
  'simulate.selectedNumbers': 'Selected numbers',
  'simulate.clear': 'Clear',
  'simulate.strongNumber': 'Strong number',
  'simulate.prizeConfig': 'Prize amounts configuration',
  'simulate.button': 'Run simulation',
  'simulate.results': 'Simulation results',
  'simulate.totalDraws': 'Total draws',
  'simulate.totalSpent': 'Total spent',
  'simulate.totalWon': 'Total won',
  'simulate.net': 'Net profit/loss',
  'simulate.tierSummary': 'Summary by prize tier',
  'simulate.tier': 'Tier',
  'simulate.hits': 'Hits',
  'simulate.amount': 'Amount',
  'simulate.drawHistory': 'Draw history',
  'simulate.drawDate': 'Date',
  'simulate.winningNumbers': 'Winning numbers',
  'simulate.strongShort': 'Strong',
  'simulate.tierHit': 'Tier hit',
  'simulate.prize': 'Prize',
  'simulate.cost': 'Cost',
  'simulate.noWins': 'No wins in the selected period',
  'simulate.maxNumbers': 'Can select up to {n} numbers',
  'simulate.needNumbers': 'Select exactly {n} numbers',
  'simulate.needStrong': 'Select a strong number',
  'simulate.realPrizes': 'Real prizes',
  'simulate.prizeSource': 'Prize source',
  'simulate.real': 'Real',
  'simulate.estimate': 'Estimate',
  'simulate.loadSaved': 'Load saved numbers',
  'simulate.selectSaved': '— Select a saved set —',
  'simulate.noSaved': 'No saved numbers. Save numbers in "My Numbers" or "Generate" first.',
  'simulate.loadedSaved': 'Saved numbers loaded',
